...
export const SECTIONS = [
  {
    ...
    subtitle: 'What AI is, and where you meet it',
    description: 'What counts as AI, the kinds that exist today, how a system learns, and where it already shows up in your feeds, maps and search results.',
    moduleTheme: 'green',
    lessons: [
  ...
  },
  {
    ...
    subtitle: 'How computers learn from examples',
    description: 'How a computer finds patterns in examples instead of following rules someone wrote, and how to tell whether the model it builds is any good.',
    moduleTheme: 'blue',
    lessons: [
  ...
  },
  {
    ...
    subtitle: 'Neurons, layers and how they train',
    description: 'A single artificial neuron, then hidden layers, activation functions and backpropagation, and the network designs built for images and for sequences like text.',
    moduleTheme: 'purple',
    lessons: [
  ...
  },
  {
    ...
    subtitle: 'Prompting, chatbots and image tools',
    description: 'Writing prompts that get you what you asked for, comparing ChatGPT, Claude and Gemini, and using image generators and GitHub Copilot.',
    moduleTheme: 'blue',
    lessons: [
  ...
  },
  {
    ...
    level: 'Advanced',
    title: 'AI Ethics',
    subtitle: 'Bias, deepfakes, privacy and judgment',
    description: 'Where AI bias comes from, how deepfakes spread misinformation, what happens to the data you share, and how to decide when using AI is appropriate.',
    moduleTheme: 'purple',
    lessons: [
